...
import static constant.Constant.SQL_QUERY_SELECT_PRESSURES;
import static constant.Constant.SQL_QUERY_SELECT_WEATHER;
...
//            Constant.SQL_QUERY_SELECT_TOMORROW_WEATHER};
    ...
    private String sqlQuerySelectLastParameters = SQL_QUERY_SELECT_WEATHER;
    private String sqlQuerySelectPressures = SQL_QUERY_SELECT_PRESSURES;
...
//    @Override
    public WeatherModel getLastWeatherByRegion(Region region, String sqlQuery){
        ...
        return collectWeatherData.getLastWeatherByRegion(region, sqlQuery);
    }
